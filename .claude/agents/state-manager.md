...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Input:  "OP_READ_STATE"
Action: Read data/state/game_state.json
...
Action: Read data/state/game_state.json, merge ONLY the
...
Action: Read data/state/session_cache.json, append data
...
Action:
  1. Read data/state/session_cache.json
  2. Read data/state/stats/SUBJECT_stats.json (hot layer only)
  ...
  7. Write updated data/history/question_history.json
  8. Write updated data/history/flagged_questions.json
...
Action:
  ...
  2. Read data/state/stats/SUBJECT_stats.json
  ...
  5. Write data/state/stats/SUBJECT_stats.json
  6. Read data/state/stats/meta_stats.json
  7. Increment total_sessions by 1
  8. Update last_updated to current ISO date
  9. Write data/state/stats/meta_stats.json
...
data/graphs/{subject}.json is loaded once at session startup
...
"data/graphs/" or "BEHECON.json" or any graph file path.
