...
test("the gate loads every bank file the app loads", () => {
  ...
  /* Lessons, diagnoses, coverage, final retrieval prompts and the mini-mock selector carry no option sets, so
  ...
  const questionFiles = shipped.filter((file) => !/t6_(lessons|diagnoses|coverage|final_sprints|mini_mocks)\.js$/.test(file));
